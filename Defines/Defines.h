...
const float GOLD_PILE_SMALL_SPAWN_CHANCE = 2.0/8.0;
const int GOLD_PILE_NORMAL_VALUE = 2;
const float GOLD_PILE_NORMAL_SPAWN_CHANCE = 5.0/8.0;
const int GOLD_PILE_MERCHANT_HOARD_VALUE = 4;
const int GOLD_PILE_DRAGON_HOARD_VALUE = 6;
const float GOLD_PILE_DRAGON_HOARD_SPAWN_CHANCE = 1.0/8.0;


// Race info:
const float SHADE_SPAWN_CHANCE = 1.0/9.0;
...
const float DROW_SPAWN_CHANCE = 1.0/9.0;
...
const int VAMPIRE_SPAWN_CHANCE = 1.0/9.0;
...
const float TROLL_SPAWN_CHANCE = 1.0/9.0;
...
const float GOBLIN_SPAWN_CHANCE = 1.0/9.0;
...
const float HUMAN_SPAWN_CHANCE = 2.0/9.0;
...
const float ORC_SPAWN_CHANCE = 1.0/9.0;
...
const float MERCHANT_SPWAN_CHANCE = 1.0/9.0;
...
const float HALFLING_SPAWN_CHANCE = 5.0/18.0;
